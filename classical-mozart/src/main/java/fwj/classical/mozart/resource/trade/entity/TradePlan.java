package fwj.classical.mozart.resource.trade.entity;
...
@Entity
public class TradePlan extends AbstractPersistable<Integer> {

	private static final long serialVersionUID = 5192523747829158795L;
	...
	private Integer status; // 1:未执行；2：执行中；3：已执行；
